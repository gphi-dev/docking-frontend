...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-950/10"
        @click.stop
      >
        <form @submit.prevent="handleConfirm">
          ...
          <div class="mt-6 flex justify-end gap-2">
            ...
            <button
              type="submit"
              class="inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
              :class="
                variant === 'danger'
                  ? 'bg-rose-600 hover:bg-rose-500 focus-visible:ring-rose-500'
                  : 'bg-emerald-950 hover:bg-emerald-900 focus-visible:ring-emerald-500'
              "
              :disabled="isSubmitting"
            >
